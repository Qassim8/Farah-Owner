        ...
        <div className="photos" dir="rtl">
            <div className="container p-5">
                ...
                <div className="important-info p-3 mb-5 position-relative">
                    <p>اختيارك الصور الواضحه التي تعبر عن الخدمات التي تقدمها بشكل مناسب هو الوسيلة الاهم لعرض اعمالك والطريقة الاسرع لزيادة عدد زوار صفحتك على موقعنا</p>
                    ...
                    <ol>
                        ...
                        <li> يجب الا تحتوي الصور على اي معلومات اتصال (هاتف - بريد الكتروني) ولا مشكلة في اضافة شعار صالتك.</li>
                    </ol>
                </div>
                <div className="add-photo d-flex p-3">
                    <input type="file" name="choose" className="open"></input>
                    <button className="btn py-2 mx-3 back-color text-white rounded-0">اضافة الصور</button>
                </div>
            </div>
        </div>
        </>
