        ...
        <div className="container p-5">
          ...
          <form className="info-form p-3">
              ...
              <div className="col-md-6">
                <div className="input px-2">
                  ...
                  <input
                    ...
                    name="hall-email"
                    className="form-control my-2 w-100"
                    placeholder="ادخل روابط التواصل الاجتماعي"
                  ></input>
                  ...
                  <input
                    ...
                    name="hall-phone"
                    className="form-control my-2 w-100"
                    placeholder="يقصد هنا 50%من المبلغ الكلي"
                  ></input>
                </div>
              </div>
            ...
            <input
              type="submit"
              value="حفظ"
              className="btn py-2 px-3 my-3 me-2 back-color fw-bold text-white rounded-0"
            />
          </form>
        </div>
      </div>
